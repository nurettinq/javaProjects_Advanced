...
public class KodKalip implements Sinif{
    ...
    public KodKalip(){}
    public KodKalip(List<String> ogretmenad, List<String> ogrenciad, int count,int ayni, List<String>oturumSaati, String dersKodu, String dersAd) {
        this.ogretmen =setOgretmen(ogrenciad, ogretmenad);
        this.ogrenciad = ogrenciad;
        setOturumSaatleri(count,oturumSaati);
        this.dersKodu = dersKodu;
        this.dersAd = dersAd;
        sinifBelirleme(ogrenciad,ayni);
